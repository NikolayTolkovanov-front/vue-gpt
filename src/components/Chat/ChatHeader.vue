<template>
  <header class="header">
    <div class="header__body">
      ...
      <div
        class="header__chat-btn"
        ref="header-chat-btn"
      >
        <div class="header__chat-btn-wrapper">
          <Tippy
            to="parent"
            trigger="click"
            :arrow="false"
          ...
          >
            <template #content="{ hide }">
              <div
                class="popup-menu"
                ref="header-chat-menu"
              >
                <ul class="header-chat">
                  <li class="header-chat__item">
                    <div class="header-chat__icon">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                    ...
                    <div class="header-chat__text">
                      <p class="header-chat__text-title">ChatGPT Plus</p>
                      <p class="header-chat__text-subtitle">
                        Наша самая умная модель и многое другое
                      </p>
                    </div>
                    <button class="header-chat__btn">Перейти на</button>
                  </li>
                  <li class="header-chat__item">
                    <div class="header-chat__icon">
                      <svg
                    ...
                    <div class="header-chat__icon--left">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
          ...
          <b class="header__chat-title">ChatGPT</b>
          <div class="header__chat-icon">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
      ...
      <!-- on mobile -->
      <button class="header__new-chat-btn">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
